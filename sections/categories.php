<?php
$categories = [
  ["slug"=>"femmes",     "title"=>"Montres femme",      "url"=>"#femmes",     "img"=>"/assets/img/cat-femmes.jpg",     "alt"=>"Montres pour femmes"],
  ["slug"=>"hommes",     "title"=>"Montres homme",      "url"=>"#hommes",     "img"=>"/assets/img/cat-hommes.jpg",     "alt"=>"Montres pour hommes"],
  ["slug"=>"enfants",    "title"=>"Montres enfant",     "url"=>"#enfants",    "img"=>"/assets/img/cat-enfants.jpg",    "alt"=>"Montres pour enfants"],
